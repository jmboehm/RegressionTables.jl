...
regtable(m1,gm1,ni1,gm2; file = joinpath(dirname(@__FILE__), "tables", "mmtest1.txt"), regression_statistics = [Nobs, R2, AdjR2, R2Within, FStat, FStatPValue, FStatIV, FStatIVPValue, DOF], digits= 1, digits_stats = 1, print_fe_section=false)
